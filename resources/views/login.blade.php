{{-- resources/views/auth/login.blade.php (ringkas) --}}
<!doctype html>
<html lang="id">
<head>
  <meta charset="utf-8">
  ...
  <style>
      html,body{height:100%;margin:0;background:#f5f7fb;overflow:hidden;}
      body{display:flex;align-items:center;justify-content:center;font-family:Inter,sans-serif}
  </style>
</head>
<body>

  <div class="card shadow-lg rounded-4 p-4 my-2" style="max-width:420px;width:100%;max-height:calc(100vh - 2rem);overflow:auto;">
      {{-- ====== form/login milikmu di sini ====== --}}
      <!-- Logo -->
